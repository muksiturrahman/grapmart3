...
class GrapFood extends StatefulWidget {
  const GrapFood({Key? key}) : super(key: key);

  @override
  State<GrapFood> createState() => _GrapFoodState();
}

class _GrapFoodState extends State<GrapFood> {
  @override
                           ...
                           Stack(
                             children: [
                               Column(
                                 ...
                                 children: [
                                   Image.network(
                                     "https://inv.grapfood.com/uploads/img/1670836441_milk_250ml.jpg",
                                     height: 150,
                                     width: 165,
                                     fit: BoxFit.fill,
                                   ),
                                   const Padding(
                                     padding: EdgeInsets.only(
                                         left: 8, top: 10, right: 8),
                                     child: Text('GrapFood Boiled Milk 250ml',
                                         style: TextStyle(
                                             fontWeight: FontWeight.bold)),
                                   ),
                                   const SizedBox(height: 8),
